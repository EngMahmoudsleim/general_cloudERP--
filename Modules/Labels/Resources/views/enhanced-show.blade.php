...
@include('labels::layouts.partials.css_custom.enhanced-labels')
@endsection
                    ...
                    <div class="label-elements">
                        ...
                        <div class="toggle-container">
                            <div class="toggle-label-wrapper">
                                ...
                                <div class="toggle-switch" style="width: 55%"></div>
                        ...
                        <div class="toggle-container">
                            <div class="toggle-label-wrapper">
                                    <input type="checkbox" name="print[price]"  id="is_show_price"  
                                        class="hidden label-toggle"  >
                                    <div class="toggle-switch" ></div>
...
@include('labels::layouts.partials.js_custom.labels-js') 

<!-- Add the new enhancement file -->
{{-- <script src="{{ asset('js/labels-enhancements.js?v=' . $asset_v) }}"></script> --}}

@include('labels::layouts.partials.js_custom.labels-enhancements-js') 
...
function initializeToggleSwitches() {
    $('.label-toggle').each(function() {
        ...
        const nameValue = this.getAttribute('id');
        ...
        $toggleSwitch.on('click', function() {
            ...
            //#JCN 2025 Include the logic to active price with TAX
            //#JCN 2025 Include the logic to active price with TAX
            if ( nameValue == 'is_show_price' && $checkbox.is(':checked') ){
                //Enabled TX
