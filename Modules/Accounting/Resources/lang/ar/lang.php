...
return [
    ...
    'total_gross_sales' => 'إجمالي المبيعات الكلي',
    'sales_returns_allowances' => 'مرتجعات وخصومات المبيعات',
    'total_sales_returns' => 'إجمالي المرتجعات',
    'net_sales' => 'صافي المبيعات',
    'account_mapping_hint_title' => 'تلميح: ربط الحسابات بالمعاملات',
    'account_mapping_hint_description' => 'إذا كنت تستخدم شجرة الحسابات الافتراضية للنظام، يمكنك استخدام الحسابات الموصى بها أدناه لتسهيل عملية الربط.',
    'show_recommended_accounts' => 'عرض الحسابات الموصى بها',
    'recommended_accounts_guide' => 'دليل الحسابات الموصى بها',
    'recommended' => 'الموصى به',
    'important_note' => 'ملاحظة مهمة',
    'mapping_note_1' => 'يمكنك تعديل هذه الإعدادات في أي وقت حسب احتياجات عملك.',
    'mapping_note_2' => 'إذا لم تكن متأكداً من الحساب المناسب، استشر محاسبك أو راجع دليل شجرة الحسابات الخاصة بك.',
    ...
    'income_statement_description' => 'تتبع إجمالي الإيرادات والمصروفات لفترة محددة لمعرفة صافي الربح أو الخسارة.',
    'assets' => 'الاصول',
