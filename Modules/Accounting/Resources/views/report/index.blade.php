...
<section class="content">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="box box-warning">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang( 'accounting::lang.income_statement')</h3>
                </div>

                <div class="box-body">
                    @lang( 'accounting::lang.income_statement_description')
                    <br/>
                    <a href="{{route('accounting.incomeStatement')}}" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm pt-2">@lang( 'accounting::lang.view_report')</a>
                </div>
