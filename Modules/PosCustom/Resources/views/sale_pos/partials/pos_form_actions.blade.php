...
<div class="hidden border-2 from-purple-500 via-purple-600 to-purple-700 border-blue-700 border-black border-purple-700 border-green-700 border-red-700 border-yellow-700 border-orange-700 border-sky-700 "></div>
...
@if ($poscustom_btnstyle == 's1')
    ...
    <div class="pos-form-actions tw-bg-white tw-fixed tw-right-0 tw-bottom-0 tw-flex tw-p-1 tw-w-full !tw-items-center tw-justify-between flex-col md:flex-row sm:flex-col lg:flex-row  
        ...
        <div class=" tw-flex tw-flex-row w-5/6 tw-gap-4 tw-justify-center tw-hidden md:tw-flex tw-overflow-x-auto">
            ...
            @if (!Gate::check('disable_pay_checkout') || auth()->user()->can('superadmin') || auth()->user()->can('admin'))        
                <button type="button" id="pos-finalize" title="@lang('lang_v1.tooltip_checkout_multi_pay')" 
                    ...
                    <p class="text_title_muted_w100"> <i class="fas fa-money-check-alt" aria-hidden="true"> @lang('lang_v1.checkout_multi_pay') </i></p>
                </button>
            @endif     
            ...
            @if (!Gate::check('disable_express_checkout') || auth()->user()->can('superadmin') || auth()->user()->can('admin'))
                <button type="button" 
                    class="pos-express-finalize 
                        ...
                        data-pay_method="cash" title="@lang('tooltip.express_checkout')">
                    <p class="text_title_muted_w100"> <i class="fas fa-money-bill-alt" aria-hidden="true"> @lang('lang_v1.express_checkout_cash') </i></p>
                </button>
            @endif
            ...
            @if (!Gate::check('disable_draft') || auth()->user()->can('superadmin') || auth()->user()->can('admin'))
                <button type="button" 
                    ...
                    <p class="text_title_muted_w100"> <i class="fas fa-edit " aria-hidden="true"> @lang('sale.draft') </i></p>
                </button>
            @endif
            ...
            @if (!Gate::check('disable_quotation') || auth()->user()->can('superadmin') || auth()->user()->can('admin'))
                <button type="button"
                    ...
                    <p class="text_title_muted_w100"><i class="fas fa-edit"></i> @lang('lang_v1.quotation')</p>
                    </button>
            @endif	
            ...
            @if (!Gate::check('disable_suspend_sale') || auth()->user()->can('superadmin') || auth()->user()->can('admin'))
                @if (empty($pos_settings['disable_suspend']))
                    <button type="button"					
                        ...
                        <p class="text_title_muted_w100"> <i class="fas fa-pause" aria-hidden="true"> @lang('lang_v1.suspend') </i></p>
                    </button>
                @endif
            @endif
            ...
            @if (!Gate::check('disable_credit_sale') || auth()->user()->can('superadmin') || auth()->user()->can('admin'))
                @if (empty($pos_settings['disable_credit_sale_button']))
                    ...
                    <button type="button"					
                        ...
                        @if (!empty($only_payment)) disabled @endif>
                        <p class="text_title_muted_w100"> <i class="fas fa-check" aria-hidden="true"> @lang('lang_v1.credit_sale') </i></p>
                    </button>
                @endif
            @endif
            ...
            @if (!Gate::check('disable_card') || auth()->user()->can('superadmin') || auth()->user()->can('admin'))
                    <button type="button"					
                        ...
                        <p class="text_title_muted_w100"> <i class="fas fa-credit-card" aria-hidden="true"> @lang('lang_v1.express_checkout_card') </i></p>
                    </button>
            @endif
            ...
            @if (empty($edit))
                    <button type="button"					
                        class="text-red-700 hover:text-white border border-red-700 hover:bg-red-500 focus:ring-4 focus:outline-none focus:ring-red-300 
                            font-medium  rounded-lg text-sm px-5 py-1.5 text-center {{-- me-2 mb-2--}}  dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-800"
                            id="pos-cancel" title="@lang('sale.cancel')">
                        <p class="text_title_muted_w100"> <i class="fas fa-window-close" aria-hidden="true"> @lang('sale.cancel') </i></p>
                    </button>
            @else
                    <button type="button"					
                        class="text-red-700 hover:text-white border border-red-700 hover:bg-red-500 focus:ring-4 focus:outline-none focus:ring-red-300 
                            font-medium  tw-hidden hiderounded-lg text-sm px-5 py-1.5 text-center {{-- me-2 mb-2--}}  dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-800"
                            id="pos-delete" @if (!empty($only_payment)) disabled @endif title="@lang('messages.delete')">
                        <p class="text_title_muted_w100"> <i class="fas fa-trash-alt" aria-hidden="true"> @lang('messages.delete') </i></p>
                    </button>
            @endif		
        ...
        <div class=" tw-flex tw-flex-row w-1/6 tw-justify-center tw-hidden md:tw-flex ">
...
@elseif ($poscustom_btnstyle == 's1t')
    ...
    <div class="pos-form-actions tw-bg-white tw-fixed tw-right-0 tw-bottom-0 tw-flex tw-p-1 tw-w-full !tw-items-center tw-justify-between flex-col md:flex-row sm:flex-col lg:flex-row  
        ...
        {{-- recent transactions buttons--}} 
        <div class=" tw-flex tw-flex-row w-1/6 !tw-items-center tw-justify-between tw-hidden md:tw-flex ">
            @if (!isset($pos_settings['hide_recent_trans']) || $pos_settings['hide_recent_trans'] == 0)
                <button type="button"					
                    class="text-white bg-gradient-to-r from-{{ $theme_color }}-500 via-{{ $theme_color }}-600 to-{{ $theme_color }}-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-{{ $theme_color }}-300 dark:focus:ring-{{ $theme_color }}-800 shadow-lg shadow-{{ $theme_color }}-500/50 dark:shadow-lg dark:shadow-{{ $theme_color }}-800/80 font-medium rounded-lg text-sm 
                            px-5 py-1.5 text-center {{-- tw-h-11 --}} {{-- me-2 mb-2 --}}"
            ...
            @if (!isset($pos_settings['hide_recent_trans']) || $pos_settings['hide_recent_trans'] == 0)
                    <button type="button"					
                        class="border tw-border-white text-white bg-gradient-to-r from-{{ $theme_color }}-500 via-{{ $theme_color }}-600 to-{{ $theme_color }}-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-{{ $theme_color }}-300 dark:focus:ring-{{ $theme_color }}-800 shadow-lg shadow-{{ $theme_color }}-500/50 dark:shadow-lg dark:shadow-{{ $theme_color }}-800/80 font-medium rounded-lg text-sm 
                            ...
                            data-toggle="modal" data-target="#recent_transactions_modal" id="recent-transactions" title="@lang('lang_v1.recent_transactions')">
                        <p  > <i class="fas fa-clock" aria-hidden="true"> @lang('lang_v1.recent_transactions') </i></p>
                    </button>
            @endif	
        </div>
    </div>
