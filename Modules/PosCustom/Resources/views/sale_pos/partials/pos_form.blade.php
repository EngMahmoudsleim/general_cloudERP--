...
<div class="row">
	<div class="col-md-6"> {{--#JCN modify from 4 to 6--}}
	...
	<div class="col-md-6">  {{--#JCN modify from 8 to 6--}}
		<div class="form-group">
			<div class="input-group">
	...
	<div class="multiCurrency-add" ></div> {{--#JCN testing MultiCurrency--}}
...
@endif
 ...
 {{-- <div class="row "> It doesnt work with the scrollbar for overflow--}}
	<div class=" @if (isMobile()) tw-h-dvh-shop1 @else {{ $size_shop }} @endif {{-- pos_product_div1  space Left --}} {{-- {{ $size_shop }}  --}}  tw-overflow-y-auto tw-overflow-hidden ">
		...
		<table class="table table-condensed table-bordered table-striped table-responsive" id="pos_table">
			<thead>
				<tr>
					...
					<th class="text-center col-md-1"><i class="fas fa-times tw-text-base" aria-hidden="true"></i></th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
