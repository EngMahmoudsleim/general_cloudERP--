        ...
        <div class="col-md-12">
            <div class="invoice-print" id="exchange_receipt">
                ...
                <div class="row">
                    <div class="col-xs-12 text-center">
                        ...
                        <hr>
                        <h4>@lang('exchangeitem::lang.exchange_receipt')</h4>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <strong>@lang('exchangeitem::lang.exchange_ref_no'):</strong> {{ $exchange->exchange_ref_no }}<br>
                        <strong>@lang('exchangeitem::lang.exchange_date'):</strong> {{
                        @format_datetime($exchange->exchange_date)
                        }}<br>
                        <strong>@lang('exchangeitem::lang.original_invoice'):</strong> {{
                    ...
                    <div class="col-xs-6">
                        ...
                        <strong>@lang('exchangeitem::lang.created_by'):</strong>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <h5>@lang('exchangeitem::lang.exchange_items_details')</h5>
                        ...
                        <table class="table">
                            ...
                            <tr class="bg-gray">
                                ...
                                <td class="text-right">
                                    ...
                                    <small>(@lang('exchangeitem::lang.customer_paid'))</small>
                                    @elseif($exchange->exchange_difference < 0) <small>
                                        (@lang('exchangeitem::lang.refunded_to_customer'))</small>
                                        @else
                                        <small>(@lang('exchangeitem::lang.even_exchange'))</small>
                                        @endif
                                </td>
                            </tr>
                        </table>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <strong>@lang('exchangeitem::lang.notes'):</strong>
                        <p>{{ $exchange->notes }}</p>
                    </div>
                </div>
                @endif
                ...
                <div class="row">
                    <div class="col-xs-12 text-center">
                        <hr>
                        <p>@lang('exchangeitem::lang.thank_you_for_your_business')</p>
                        <small>@lang('exchangeitem::lang.exchange_receipt_footer')</small>
                    </div>
                </div>
            </div>
            ...
            <div class="row no-print">
                <div class="col-xs-12 text-center">
                    ...
                    <a href="{{ route('exchangeitem.index') }}" class="btn btn-default">
