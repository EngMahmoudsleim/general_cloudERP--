        ...
        <div class="modal-content">
            <div class="modal-header bg-gray dark:bg-gray-800">
                ...
                <h4 class="modal-title" id="exchangeModalLabel">
                    <i class="fas fa-exchange-alt"></i> @lang('exchangeitem::lang.add_exchange')
                </h4>
            </div>
            ...
            <div class="modal-body">
                ...
                <div id="exchange-step-1" class="exchange-step">
                    <div class="row">
                        <div class="col-md-6">
                            <h5><i class="fas fa-search"></i> @lang('exchangeitem::lang.step_1_search_invoice')</h5>
                            <div class="form-group">
                                <label for="pos_exchange_invoice">@lang('exchangeitem::lang.invoice_number'):</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="pos_exchange_invoice"
                                           placeholder="@lang('exchangeitem::lang.invoice_number')">
                                    <span class="input-group-btn">
                                        <button type="button" class="btn btn-primary" id="pos_search_exchange_invoice">
                                            <i class="fas fa-search"></i> @lang('exchangeitem::lang.search_invoice')
                                        </button>
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div id="pos_exchange_transaction_info" style="display: none;">
                                <h5>@lang('exchangeitem::lang.original_transaction')</h5>
                ...
                <div id="exchange-step-2" class="exchange-step" style="display: none;">
                    <h5><i class="fas fa-list"></i> @lang('exchangeitem::lang.step_2_select_items')</h5>
                    <div id="pos_exchangeable_items_table"></div>
                    <div class="text-center" style="margin-top: 20px;">
                        <button type="button" class="btn btn-success" id="pos_add_exchange_items">
                            <i class="fas fa-plus"></i> @lang('exchangeitem::lang.add_selected_items')
                        </button>
                    </div>
                </div>
                ...
                <div id="exchange-step-3" class="exchange-step" style="display: none;">
                    <h5><i class="fas fa-calculator"></i> @lang('exchangeitem::lang.exchange_summary')</h5>
                    <div class="row">
                        <div class="col-md-6">
                            <table class="table table-striped">
                                <tr>
                                    <th>@lang('exchangeitem::lang.total_return_value'):</th>
                                    <td><span id="pos_total_return_amount" class="display_currency">0.00</span></td>
                                </tr>
                                <tr>
                                    <th>@lang('exchangeitem::lang.total_new_value'):</th>
                                    <td><span id="pos_total_new_amount" class="display_currency">0.00</span></td>
                                </tr>
                                <tr class="bg-info">
                                    <th>@lang('exchangeitem::lang.net_exchange_amount'):</th>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="pos_exchange_notes">@lang('exchangeitem::lang.notes'):</label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="pos_complete_exchange" style="display: none;">
                    <i class="fas fa-check"></i> @lang('exchangeitem::lang.complete_exchange')
                </button>
            </div>
        </div>
    </div>
