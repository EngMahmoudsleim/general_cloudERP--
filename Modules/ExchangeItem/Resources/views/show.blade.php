    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">
                @lang('exchangeitem::lang.exchange_details') - {{ $exchange->exchange_ref_no }}
            </h4>
        </div>
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box box-solid">
                        <div class="box-header with-border">
                            <h3 class="box-title">@lang('exchangeitem::lang.exchange_information')</h3>
                        </div>
                        <div class="box-body">
                            <table class="table table-condensed">
                                <tr>
                                    <th>@lang('exchangeitem::lang.exchange_ref_no'):</th>
                                    <td>{{ $exchange->exchange_ref_no }}</td>
                                </tr>
                                <tr>
                                    <th>@lang('exchangeitem::lang.exchange_date'):</th>
                                ...
                                <tr>
                                    <th>@lang('exchangeitem::lang.created_by'):</th>
                                    <td>{{ $exchange->creator->name ?? 'N/A' }}</td>
                                </tr>
                                @if($exchange->notes)
                                <tr>
                                    <th>@lang('exchangeitem::lang.notes'):</th>
                ...
                <div class="col-md-6">
                    <div class="box box-solid">
                        <div class="box-header with-border">
                            <h3 class="box-title">@lang('exchangeitem::lang.original_transaction')</h3>
                        </div>
                        <div class="box-body">
                            <table class="table table-condensed">
                                <tr>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-solid">
                        <div class="box-header with-border">
                            <h3 class="box-title">@lang('exchangeitem::lang.exchange_items_details')</h3>
                        </div>
                        <div class="box-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @endif
                                                @else
                                                @lang('exchangeitem::lang.deleted_product')
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <em>@lang('exchangeitem::lang.return_only')</em>
                                                @else
                                                @lang('exchangeitem::lang.deleted_product')
                                                @endif
                                            </td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <small class="label label-{{ $difference > 0 ? 'danger' : 'success' }}">
                                                    {{ $difference > 0 ? __('exchangeitem::lang.customer_pays') :
                                                    __('exchangeitem::lang.refund_due') }}
                                                </small>
                                                @else
                                                <span class="text-muted">@lang('exchangeitem::lang.no_difference')</span>
                                                @endif
                                            </td>
                                        </tr>
                                        @endforeach
                                    ...
                                    <tfoot>
                                        <tr class="bg-gray">
                                            <th colspan="5" class="text-right">@lang('exchangeitem::lang.total'):</th>
                                            <th>
                                                <span class="display_currency" data-currency_symbol="true">
                                                    {{ $total_return_amount }}
                                                </span>
                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="box box-success">
                        <div class="box-header with-border text-center">
                            <h3 class="box-title">@lang('exchangeitem::lang.exchange_summary')</h3>
                        </div>
                        <div class="box-body">
                            <table class="table table-condensed">
                                <tr>
                                    <th class="text-right">@lang('exchangeitem::lang.total_return_value'):</th>
                                    <td class="text-right">
                                        <span class="display_currency" data-currency_symbol="true">{{
                                ...
                                <tr>
                                    <th class="text-right">@lang('exchangeitem::lang.total_new_value'):</th>
                                    <td class="text-right">
                                ...
                                <tr class="bg-gray">
                                    <th class="text-right">@lang('exchangeitem::lang.net_exchange_amount'):</th>
                                    <td class="text-right">
                                        <strong>
                                            <span
                                        ...
                                        <br><small class="text-muted">(@lang('exchangeitem::lang.customer_paid'))</small>
                                        @elseif($exchange->total_exchange_amount < 0) <br><small
                                                class="text-muted">(@lang('exchangeitem::lang.refunded_to_customer'))</small>
                                            @else
                                            <br><small
                                                class="text-muted">(@lang('exchangeitem::lang.even_exchange'))</small>
                                            @endif
                                    </td>
                                </tr>
                            </table>
        ...
        <div class="modal-footer">
            ...
            <a href="#" class="print-invoice btn btn-primary"
                ...
                <i class="fa fa-print"></i> @lang('exchangeitem::lang.print_invoice')
            </a>

            <a href="{{ route('exchangeitem.print', [$exchange->id]) }}" class="btn btn-success" target="_blank">
                <i class="fa fa-receipt"></i> @lang('exchangeitem::lang.print_exchange_receipt')
            </a>
            @endcan
            @endif
