...
@section('title', __('exchangeitem::lang.exchange_receipt'))
        ...
        <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-xs-12 text-center">
                        ...
                        <h4
                            ...
                            @lang('exchangeitem::lang.exchange_receipt')
                        </h4>
                    </div>
                </div>
                ...
                <div class="row" style="margin-bottom: 20px;">
                        ...
                        <table style="width: 100%; font-size: 13px;">
                            <tr>
                                <td style="padding: 3px 0; font-weight: bold; width: 40%;">
                                    @lang('exchangeitem::lang.exchange_ref_no'):</td>
                                <td style="padding: 3px 0;"><strong>{{ $exchange->exchange_ref_no }}</strong></td>
                            </tr>
                            <tr>
                                <td style="padding: 3px 0; font-weight: bold;">@lang('exchangeitem::lang.exchange_date'):
                                </td>
                                <td style="padding: 3px 0;">{{
                                    \Carbon\Carbon::parse($exchange->exchange_date)->format('d/m/Y H:i') }}</td>
                            </tr>
                            <tr>
                                <td style="padding: 3px 0; font-weight: bold;">@lang('exchangeitem::lang.original_invoice'):
                                </td>
                    ...
                    <div class="col-xs-6">
                        <table style="width: 100%; font-size: 13px;">
                            ...
                            <tr>
                                <td style="padding: 3px 0; font-weight: bold;">@lang('exchangeitem::lang.created_by'):</td>
                                <td style="padding: 3px 0;">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <h5
                            ...
                            @lang('exchangeitem::lang.exchange_items_details')
                        </h5>
                                ...
                                <thead>
                                    <tr style="background: #f5f5f5;">
                                        <th style="padding: 8px; border: 1px solid #ddd; text-align: center;">
                                            @lang('exchangeitem::lang.return_item')</th>
                                        <th
                                            style="padding: 8px; border: 1px solid #ddd; text-align: center; width: 10%;">
                                            @lang('exchangeitem::lang.return_qty')</th>
                                        <th
                                            style="padding: 8px; border: 1px solid #ddd; text-align: center; width: 12%;">
                                            @lang('exchangeitem::lang.return_amount')</th>
                                        <th style="padding: 8px; border: 1px solid #ddd; text-align: center;">
                                            @lang('exchangeitem::lang.new_item')</th>
                                        <th
                                            style="padding: 8px; border: 1px solid #ddd; text-align: center; width: 10%;">
                                            @lang('exchangeitem::lang.new_qty')</th>
                                        <th
                                            style="padding: 8px; border: 1px solid #ddd; text-align: center; width: 12%;">
                                            @lang('exchangeitem::lang.new_amount')</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @php
                                    ...
                                    <tr>
                                        <td style="padding: 8px; border: 1px solid #ddd; vertical-align: top;">
                                            ...
                                            @endif
                                            @else
                                            <em style="color: #999;">@lang('exchangeitem::lang.deleted_product')</em>
                                            @endif
                                        </td>
                                        ...
                                        <td style="padding: 8px; border: 1px solid #ddd; vertical-align: top;">
                                            ...
                                            <em style="color: #d9534f;">@lang('exchangeitem::lang.return_only')</em>
                                            @else
                                            <em style="color: #999;">@lang('exchangeitem::lang.deleted_product')</em>
                                            @endif
                                        </td>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <h5
                            ...
                            @lang('exchangeitem::lang.exchange_summary')
                        </h5>
                        <table class="table" style="font-size: 13px; margin-bottom: 20px;">
                            <tr>
                                <th style="text-align: right; padding: 8px; border-bottom: 1px solid #ddd; width: 70%;">
                                    @lang('exchangeitem::lang.total_return_value'):
                                </th>
                            ...
                            <tr>
                                <th style="text-align: right; padding: 8px; border-bottom: 1px solid #ddd;">
                                    @lang('exchangeitem::lang.total_new_value'):
                                </th>
                                <td style="text-align: right; padding: 8px; border-bottom: 1px solid #ddd;">
                            ...
                            <tr style="background: #e8f5e8; font-size: 14px;">
                                <th
                                    ...
                                    @lang('exchangeitem::lang.net_exchange_amount'):
                                </th>
                                <td
                                    ...
                                    <br><small
                                        style="color: #856404; font-style: italic;">(@lang('exchangeitem::lang.customer_paid'))</small>
                                    @elseif($exchange->exchange_difference < 0) <br><small
                                            style="color: #721c24; font-style: italic;">(@lang('exchangeitem::lang.refunded_to_customer'))</small>
                                        @else
                                        <br><small
                                            style="color: #155724; font-style: italic;">(@lang('exchangeitem::lang.even_exchange'))</small>
                                        @endif
                                </td>
                            </tr>
                        </table>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div
                            ...
                            <strong style="color: #856404;">@lang('exchangeitem::lang.notes'):</strong>
                ...
                <div class="row">
                    <div class="col-xs-12 text-center">
                        ...
                        <p style="margin: 10px 0; font-weight: bold; font-size: 14px;">
                            @lang('exchangeitem::lang.thank_you_for_your_business')</p>
                        <small style="color: #666; font-style: italic;">
                            @lang('exchangeitem::lang.exchange_receipt_footer') |
            ...
            <div class="row no-print">
                <div class="col-xs-12 text-center"
                    ...
                    <a href="{{ route('exchangeitem.print-only', $exchange->id) }}" target="_blank"
                        class="btn btn-primary btn-lg" style="margin: 5px;">
                        <i class="fa fa-print"></i> Print M2
                    </a>
                    @endif
                    <a href="{{ route('exchangeitem.index') }}" class="btn btn-default btn-lg" style="margin: 5px;">
                        <i class="fa fa-arrow-left"></i> @lang('exchangeitem::lang.back')
                    </a>
                </div>
            </div>
        </div>
