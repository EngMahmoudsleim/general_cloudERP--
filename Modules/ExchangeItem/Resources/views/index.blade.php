...
@section('title', __('exchangeitem::lang.exchange_list'))

@section('content')
<section class="content-header no-print">
    <h1>@lang('exchangeitem::lang.exchange')
        <small>@lang('exchangeitem::lang.manage_your_exchanges')</small>
    </h1>
</section>
...
<section class="content no-print">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                'form-control select2', 'style' => 'width:100%', 'placeholder' => __('exchangeitem::lang.all')]) !!}
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                'style' => 'width:100%', 'placeholder' => __('exchangeitem::lang.all')]) !!}
            </div>
        </div>
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                'completed' => __('exchangeitem::lang.completed'),
                'cancelled' => __('exchangeitem::lang.cancelled')
                ], null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' =>
                __('exchangeitem::lang.all')]) !!}
            </div>
        </div>
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                __('exchangeitem::lang.select_a_date_range'), 'class' => 'form-control', 'readonly']) !!}
            </div>
        </div>
        ...
        <div class="col-md-2">
            <div class="form-group">
                {!! Form::label('exchange_list_filter_created_by', __('exchangeitem::lang.created_by') . ':') !!}
    ...
    <!-- Table Component -->
    @component('components.widget', ['class' => 'box-primary', 'title' => __('exchangeitem::lang.all_exchanges')])
    @slot('tool')
    <div class="box-tools">
        @can('exchange.create')
        <a class="btn btn-block btn-primary"
            href="{{action([\Modules\ExchangeItem\Http\Controllers\ExchangeController::class, 'create'])}}">
            <i class="fa fa-plus"></i> @lang('exchangeitem::lang.create_exchange')
        </a>
        @endcan
    </div>
    @endslot
        ...
        <table class="table table-bordered table-striped" id="exchanges_table">
            <thead>
                <tr>
                    ...
                    <th>@lang('exchangeitem::lang.original_invoice')</th>
                    <th>@lang('exchangeitem::lang.exchange_invoice')</th>
                    <th>@lang('contact.customer')</th>
                    <th>@lang('exchangeitem::lang.exchange_amount')</th>
...
<script>
    $(document).ready(function() {
        ...
        $('#exchange_list_filter_customer_id').select2({
            ...
            placeholder: '@lang("exchangeitem::lang.all")',
        ...
        $(document).on('click', '.cancel-exchange', function(e) {
            ...
            swal({
                title: '@lang("exchangeitem::lang.are_you_sure")',
                text: '@lang("exchangeitem::lang.cancel_exchange_confirmation")',
                icon: "warning",
                buttons: true,
                dangerMode: true,
            }).then((confirmed) => {
