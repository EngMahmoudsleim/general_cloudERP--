...
namespace Modules\ExchangeItem\Console;
...
class PublishAssetsCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'exchangeitem:publish-assets {--force : Overwrite existing files}';
     ...
     * @var string
     */
    protected $description = 'Publish ExchangeItem module assets to public directory';
    ...
    {
        $this->info('Publishing ExchangeItem module assets...');
        ...
        $this->call('vendor:publish', [
            '--tag' => 'exchangeitem-pos-js',
            '--force' => $this->option('force')
        ]);

        $this->info('ExchangeItem assets published successfully!');
    }
}