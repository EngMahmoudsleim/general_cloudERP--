...
namespace Modules\ExchangeItem\Entities;
...
class TransactionExchange extends Model
{
    protected $fillable = [
        ...
        'return_transaction_id',    // NEW: Sell return transaction
        'exchange_ref_no',
        'exchange_date',
        ...
        'notes',
        'cancelled_by',
        'stock_adjustments'         // JSON data for stock reversal
    ];
    ...
    public static function getUsersForDropdown($business_id)
    {
        ...
        $dropdown = ['' => __('exchangeitem::lang.all')]; // Add "All" option
