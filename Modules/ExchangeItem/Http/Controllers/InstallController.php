...
class InstallController extends Controller
{
    ...
    {
        $this->module_name = 'ExchangeItem';
        $this->appVersion = config('exchangeitem.module_version');
        $this->module_display_name = 'ExchangeItem';
    }
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            try {
                ...
                Artisan::call('module:migrate', ['module' => 'ExchangeItem', '--force' => true]);

                // Debug: Check after migration
                \Log::info('Migration completed');

                // Artisan::call('module:publish', ['module' => 'ExchangeItem']);
                System::addProperty($this->module_name . '_version', $this->appVersion);
                // DB::commit();
            } catch (\Exception $e) {
        ...
        $output = [
            'success' => 1,
            'msg' => 'ExchangeItem module installed succesfully',
        ];
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = [
                'success' => 1,
                'msg' => 'ExchangeItem module updated Succesfully to version ' . $this->appVersion . ' !!',
            ];
    ...
    public function uninstall()
    {
        ...
        try {
            ...
            $output = [
                'success' => true,
                'msg' => __('exchangeitem::lang.success'),
            ];
        } catch (\Exception $e) {
            $output = [
                'success' => false,
