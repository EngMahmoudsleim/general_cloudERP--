...
//////////////////////////////////////////////////////////////////////////
 if (auth()->user()->can('customer.view') || auth()->user()->can('supplier.view') || auth()->user()->can('customer.view_own') || auth()->user()->can('supplier.view_own')) {
                    $menu->url(
                        action([\App\Http\Controllers\ContactController::class, 'vouchers']),
                        __('lang_v1.receipt_and_payment_vouchers'),
                        ...
                        <path d="M9 3l-3 4" />
                        <path d="M15 3l3 4" />
                        </svg>', 'active' => request()->segment(1) == 'contacts' && request()->segment(2) == 'vouchers']
                    )->order(16);
                }
