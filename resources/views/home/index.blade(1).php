    ...
    <div class="tw-px-4 lg:tw-px-6 tw-pt-4 tw-space-y-6">
                ...
                <div class="tw-grid tw-grid-cols-1 tw-gap-3 sm:tw-grid-cols-2 xl:tw-grid-cols-4">
                    ...
                    @can('sell.create')
                        <a href="{{ route('sells.create') }}"
                            class="quick-action tw-group tw-flex tw-items-center tw-justify-between tw-gap-4 tw-p-4">
                            <div>
                                <p class="tw-text-xs tw-font-semibold tw-text-white/80">{{ __('sale.add_sale') }}</p>
        ...
        @if (auth()->user()->can('dashboard.data') && $is_admin)
            <div class="dashboard-grid">
                ...
                <div class="stat-card tw-p-4 sm:tw-p-5">
                    <div class="tw-flex tw-items-center tw-gap-4">
                        <span class="stat-card__icon tw-inline-flex tw-items-center tw-justify-center tw-size-12 tw-rounded-2xl tw-bg-sky-100 tw-text-sky-600">
                ...
                <div class="stat-card tw-p-4 sm:tw-p-5">
                    <div class="tw-flex tw-items-center tw-gap-4">
                        <span class="stat-card__icon tw-inline-flex tw-items-center tw-justify-center tw-size-12 tw-rounded-2xl tw-bg-emerald-100 tw-text-emerald-600">
                            <svg aria-hidden="true" class="tw-w-6 tw-h-6" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="stat-card tw-p-4 sm:tw-p-5">
                    <div class="tw-flex tw-items-center tw-gap-4">
                        <span class="stat-card__icon tw-inline-flex tw-items-center tw-justify-center tw-size-12 tw-rounded-2xl tw-bg-amber-100 tw-text-amber-600">
                            <svg aria-hidden="true" class="tw-w-6 tw-h-6" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <div class="stat-card tw-p-4 sm:tw-p-5">
                    <div class="tw-flex tw-items-center tw-gap-4">
                        <span class="stat-card__icon tw-inline-flex tw-items-center tw-justify-center tw-size-12 tw-rounded-2xl tw-bg-rose-100 tw-text-rose-600">
                            <svg aria-hidden="true" class="tw-w-6 tw-h-6" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <div class="stat-card tw-p-4 sm:tw-p-5">
                    <div class="tw-flex tw-items-center tw-gap-4">
                        <span class="stat-card__icon tw-inline-flex tw-items-center tw-justify-center tw-size-12 tw-rounded-2xl tw-bg-indigo-100 tw-text-indigo-600">
                ...
                <div class="stat-card tw-p-4 sm:tw-p-5">
                    <div class="tw-flex tw-items-center tw-gap-4">
                        <span class="stat-card__icon tw-inline-flex tw-items-center tw-justify-center tw-size-12 tw-rounded-2xl tw-bg-amber-50 tw-text-amber-600">
                            <svg aria-hidden="true" class="tw-w-6 tw-h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                <path d="M12 9v4" />
                ...
                <div class="stat-card tw-p-4 sm:tw-p-5">
                    <div class="tw-flex tw-items-center tw-gap-4">
                        <span class="stat-card__icon tw-inline-flex tw-items-center tw-justify-center tw-size-12 tw-rounded-2xl tw-bg-rose-50 tw-text-rose-600">
                            <svg aria-hidden="true" class="tw-w-6 tw-h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <div class="stat-card tw-p-4 sm:tw-p-5">
                    <div class="tw-flex tw-items-center tw-gap-4">
                        <span class="stat-card__icon tw-inline-flex tw-items-center tw-justify-center tw-size-12 tw-rounded-2xl tw-bg-blue-50 tw-text-blue-700">
                            <svg aria-hidden="true" class="tw-w-6 tw-h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        <div class="tw-flex-1 tw-min-w-0">
                            <p class="tw-text-sm tw-font-medium tw-text-slate-500">{{ __('home.expense') }}</p>
                            <p class="expense tw-mt-0.5 tw-text-slate-900 tw-text-2xl tw-truncate tw-font-semibold tw-tracking-tight tw-font-mono"></p>
                        </div>
                    </div>
                </div>
        ...
        @endif
    <!--- التعديل هنا here  this is here editing التعديل هنا --->
@endsection
