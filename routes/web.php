...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/contacts/payments/{contact_id}', [ContactController::class, 'getContactPayments']);
      Route::get('/contacts/vouchers', [ContactController::class, 'vouchers'])->name('contacts.vouchers');
    Route::get('/contacts/vouchers/{contact}', [ContactController::class, 'voucherSummary']);
    ...
    Route::get('/payments/contact-summary/{contact_id}', [TransactionPaymentController::class, 'getContactVoucherSummary']);
...
Route::get('/payments/get-payments', [TransactionPaymentController::class, 'getPayments'])->name('payments.get');
Route::get('/payments/dashboard-stats', [TransactionPaymentController::class, 'getDashboardStats'])->name('payments.stats');
    // Dashboard stats for vouchers
Route::get('/vouchers/dashboard-stats', [TransactionPaymentController::class, 'getDashboardStats']);

// Contact summary for vouchers
Route::get('/vouchers/contact-summary/{contact_id}', [TransactionPaymentController::class, 'getContactVoucherSummary']);


Route::get('/vouchers', [VoucherController::class, 'index'])->name('vouchers.index');
Route::get('/vouchers/get-vouchers', [VoucherController::class, 'getVouchers'])->name('vouchers.get');

// في ملف web.php - أضف هذا السطر مع الـ payments routes
  //  Route::get('/payments/dashboard-stats', [TransactionPaymentController::class, 'getDashboardStats'])->name('payments.dashboard-stats');
    //Printers...
